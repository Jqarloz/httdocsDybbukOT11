...
<div id="SocialLinkup" class="Submenu">
    ...
    <div style="background-color: rgb(0, 0, 0);" id="submenu_bug" class="Submenuitem">
      ...
      <img class="SocialLinkupLogo" src="./layouts/tibiacom/images/bola.png">
      <div class="SubmenuitemLabel"><font style="color: orange;">Nuestros Sistemas</font></div>
      <div class="RightChain" style="background-image:url(./layouts/tibiacom/images/general/chain.gif);"></div>
    </div>

  <a href="index.php?subtopic=resetinfo">
    <div style="background-color: rgb(13, 46, 43);" id="submenu_bug" class="Submenuitem" onmouseover="MouseOverSubmenuItem(this)" onmouseout="MouseOutSubmenuItem(this)">
      <div class="LeftChain" style="background-image:url(./layouts/tibiacom/images/general/chain.gif);"></div>
      <div id="ActiveSubmenuItemIcon_bug" class="ActiveSubmenuItemIcon"></div>
      <div class="SubmenuitemLabel"><font style="center">Reset System</font></div>
      <div class="RightChain" style="background-image:url(./layouts/tibiacom/images/general/chain.gif);"></div>
    </div>
  </a>

  <a href="index.php?subtopic=resetlocal">
    <div style="background-color: rgb(13, 46, 43);" id="submenu_bug" class="Submenuitem" onmouseover="MouseOverSubmenuItem(this)" onmouseout="MouseOutSubmenuItem(this)">
      <div class="LeftChain" style="background-image:url(./layouts/tibiacom/images/general/chain.gif);"></div>
      <div id="ActiveSubmenuItemIcon_bug" class="ActiveSubmenuItemIcon"></div>
      <div class="SubmenuitemLabel"><font style="center">Puntos x Level</font></div>
      <div class="RightChain" style="background-image:url(./layouts/tibiacom/images/general/chain.gif);"></div>
    </div>
  </a>
...
<a href="https://www.facebook.com/DybbukOTServer/" target="_blank">
    <div style="background-color: rgb(13, 46, 43);" id="submenu_bug" class="Submenuitem" onmouseover="MouseOverSubmenuItem(this)" onmouseout="MouseOutSubmenuItem(this)">
      <div class="LeftChain" style="background-image:url(./layouts/tibiacom/images/general/chain.gif);"></div>
      <div id="ActiveSubmenuItemIcon_bug" class="ActiveSubmenuItemIcon"></div>
