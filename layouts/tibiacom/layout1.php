...
<!--div id="NetworksBox" class="Themebox"  style="background-image:url(<-?PHP echo "$layout_name"; ?>/images/themeboxes/networksbox.png);" >
  <div id="FacebookBlock" >
    <div id="FacebookLikeBox" >
      <div class="fb-like-box" data-href="https://www.facebook.com/DybbukOTServer" data-width="175" data-height="180" data-show-faces="true" data-stream="false" data-border-color="none" data-header="false"></div>
    </div>
    <div id="FacebookSendBox" >
      <div class="fb-send" data-href="https://www.facebook.com/DybbukOTServer" data-width="50" data-height="20" ></div>
    </div>
    <div id="FacebookLikes" >
      <div class="fb-like" data-href="https://www.facebook.com/DybbukOTServer" data-width="50" data-layout="standard" data-show-faces="false" ></div>
    </div>
  </div>
  <div id="TwitterBlock" >
...
<!-- -->
		...
		<center>
			<table class="tituloContainer">
			<tr><td colspan="4">Dybbuk OT 11</td></tr>
			</table>
			<table class="countdownContainer">
				<tr>
					<td colspan="4" class="info">Server Online in:</td>
				</tr>
				<tr class="infonum">
				<b>
					<td id="days"></td>
				...
				<tr><td colspan="4"><a href="http://www.mediafire.com/file/9g6im97va1po65n/DybkOT10.97.zip" target="_blank"><img width="25%" height="25%" src="http://www.aurera-global.com/layouts/tibiacom/images/content/download_windows.gif"></img></a></td></tr>
			...
			<script src="<?PHP echo $layout_name; ?>/countdown.js"></script>
			<script>
				var callbackfunction = function(){
					console.log('Done!');
				}
				countdown('11/15/2016 4:00:00 PM', ['days', 'hours', 'min', 'sec'], callbackfunction);
			</script>
      </div>
     </div>
    </div>
