	...
	<center> <h1>DONACIÓN POR SMS </h1></center>
	<center>
<img src="http://i32.tinypic.com/2j42exj.jpg" alt="Image and video hosting by TinyPic" border="0">
	</center>
	<h2> Para este donación solo sigue los pasos de la WEB y en esta parte: 
	</br>
	</br>
	<center>
	<img src="http://i61.tinypic.com/dwamwj.jpg" border="0">
	</center>
	</br>
	</br>
	En el espacio en blanco coloca tu ACCOUNT NAME Esto para que podamos agregarte tus puntos de forma rápida. Solo funciona la sección de SMS.
	<h1>ES IMPORTANTE ACLARAR QUE POR CADA MENSAJE DE DONACIÓN EL SERVER TE AGRADECERÁ PREMIUM POINTS:</h1>
	<h2>
	<ul>	
	</center>
<li>10 Premium Points - Mexico</li>
<li>10 Premium Points - Argentina</li>
<li>15 Premium Points - Brazil </li>
<li>15 Premium Points - Canada</li>
<li>15 Premium Points - USA</li>
<li>15 Premium Points - Chile </li>
<li>10 Premium Points - Colombia</li>
<li>15 Premium Points - Europa en general</li>
<li>05 Premium Points - Venezuela </li>
<li>10 Premium Points - Uruguay</li>
<li>08 Premium Points - Peru</li>
</ul>
	</h2>
		  <center><h1>Recuerde que las donaciones las activa el Staff por lo que pueden no llegar al momento.</h1></center>
<?php
...
*/
$config['paypal_not_active'] = false; // config is in './custom_scripts/paypal/'
$config['zaypay_not_active'] = false; // config is in './custom_scripts/zaypay/'
...
if($_REQUEST['system'] == 'dotpay' && $config['dotpay_not_active'])
{
	#################################################################################
...
elseif ($_REQUEST['system'] == 'homepay' && $config['homepay_not_active'])
{
	#################################################################################
	$sms_type = (int) $_POST['sms_type'];
	$posted_code = trim($_POST['code']);
...
elseif ($_REQUEST['system'] == 'zaypay' && $config['zaypay_not_active'])
{
	if($logged)
	{
