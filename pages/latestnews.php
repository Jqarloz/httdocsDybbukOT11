...
<div id="LayerPop2" align="center" style="position: absolute; top:-520px; margin:auto; padding:auto; width: 100%; z-index: 5000;"><a href="?subtopic=donar" target="_BLANK"><img src="/images/1.jpg" WIDTH="50%" HEIGHT="50%" class="imgBorder"></a><BR /><input type="button" name="fechar" value="FECHAR" onclick="document.getElementById('LayerPop').style.display = 'none';document.getElementById('LayerPop2').style.display = 'none'" style="font-family: Verdana; font-weight: bold; font-size:10px;  color: #FFFFFF; background-color: #000000; border: 1px solid #fffff;"></div>
...
<div class="BoxContent" style="background-image: url('.$layout_name.'/images/content/scroll.gif);">
    <table width="100%">
        ...
        <tr>
            <td align="center" colspan="2"><center><img src="'.$layout_name.'/images/img/1.gif" ></center></td>
            <td align="center" colspan="2"><center><img src="'.$layout_name.'/images/img/2.gif"></center></td>
            <td align="center" colspan="2"><center><img src="'.$layout_name.'/images/img/3.gif"></center></td>
        </tr>
        <tr>
            <td align="center" colspan="6"><center><a href="index.php?subtopic=resetinfo" class="btn">More Info</a></center></td>
        </tr>
    </table>
';
//##################### ADD NEW TICKER #####################
...
$news_content .= '<a href="deleteticker&id='.$time.'"><img src="'.$layout_name.'/images/news/delete.png" border="0"></a>';
        ...
        <div class="Border_3">
            ...
            <div id="TeaserThumbnail"><img src="layouts/tibiacom/images/news/quadroinicio.gif"  width="200" height="125" border="1" alt="" align="right" hspace="0"></div>
                <div id="TeaserText">
				 ...
				 <font size="2px"></font><center><font size="2px"><b> IP:</b> Dybbuk.sytes.net |&nbsp;  <b>Port:</b> 7171 |&nbsp;  <b>Version:</b> 10.97</font> <br>  <a href="index.php?subtopic=downloads">Download Client</a> || <a href="index.php?subtopic=createaccount">Crear Cuenta</a></center><br><font size="2px">Bienvenido a <b><font color="green">Dybbuk OT Server</font></b>, contamos con <b>RLMAP</b> ademas de un mapa custom clasico de <b>DybbukOT</b>, Quest principales <b>Sin Misiones</b>, Cooldown y Magias reformulados para un PVP mas dinamico y divertido. <b>Exp shared 100%, All Quests</b>. Diversos bugs arreglados. Unete a nuestra comunidad!
                </font> </div>
 <fieldset>
					<legend>
						<font face="tahoma">Nuestro facebook official!</font>
					</legend><center>
						<div class="fb-page" data-href="https://www.facebook.com/DybbukOTServer" data-tabs="timeline" data-width="500" data-height="300" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="false"><blockquote cite="https://www.facebook.com/DybbukOTServer" class="fb-xfbml-parse-ignore"><a href="https://www.facebook.com/DybbukOTServer">Dybbuk OT Server</a></blockquote></div>
					</center></fieldset>
	 </div>
            </div>
        </div>
