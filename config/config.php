...
$config['site']['serverPath'] = "C:/DybbukOT11.0/";
...
$config['site']['newaccount_premdays'] = 2;
...
$config['site']['mail_address'] = "juancarlos.hs.1994@gmail.com"; # SEU EMAIL (TEM QUE SER GMAIL)
...
$config['site']['smtp_user'] = "juancarlos.hs.1994@gmail.com";  # SEU EMAIL (TEM QUE SER GMAIL)
$config['site']['smtp_pass'] = "donni123";  # sua senha
...
$config['paypal']['email'] = ''; ## EMAIL PAYPAL ##
